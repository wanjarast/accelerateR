...
```{r , eval = F}
model.svm <- svm(x = train.rescaled , y = real.train.bev$Bev , type = "C-classification" , kernel = "radial" , class.weights = c((1/table(real.train.bev$Bev))*max(table(real.train.bev$Bev))))
```
